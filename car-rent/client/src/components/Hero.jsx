...
const Hero = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    // ✅ Corrected the navigate URL (removed spaces)
    navigate(
  ...
  return (
    ...
    transition={{duration:0, delay:0.2}}
      ...
      >
        ...
        whileTap={{scale:0.95}}
          type="submit"
          className="flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 bg-blue-500 hover:bg-blue-dull text-white rounded-full cursor-pointer"
        >
