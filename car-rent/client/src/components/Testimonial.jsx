...
const Textimonial = () => {
 ...
 const testimonials = [
        ...
        testimonial: "Car Rental made my trip so much easier. The car was delivered right to my door, and customer service was fantastic!"
        },
          {  name: "John Wick",
         location: "Paris, France",
          image: assets.testimonial_image_1,
        testimonial: "I highly recommend CarRental! There fleet is amazing, and I always feel like I a'm getting the best deal with great service."
        }
    ];
