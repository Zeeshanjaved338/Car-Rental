...
const Banner = () => {
  ...
  [#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      ...
      <div className='text-white'>
        ...
        <p className='max-w-130'>We take care of insurance, driver verifications secure payments - 
            ...
            text-blue-500 rounded-lg text-sm mt-4 cursor-pointer'>List your car</motion.button>
      </div>
      <motion.img 
