...
const handleSubmit = async (e) => {
  ...
  try {
    const { data } = await axios.post('/api/bookings/create', {
      ...
      pickupDate,
      returnDate,
      location: car.location, // ✅ added this line
    });
...
<div className='flex flex-col gap-2'>
  ...
  eounded-lg' required id='pickup-date' min={new Date().toISOString().
    split('T')[0] }/>
</div>
...
<div className='flex flex-col gap-2'>
  ...
  type="date" className='border border-borderColor px-3 py-2
  eounded-lg' required id='Return Date' />
</div>

<button className='w-full bg-blue-500 hover:bg-blue-500-dull 
